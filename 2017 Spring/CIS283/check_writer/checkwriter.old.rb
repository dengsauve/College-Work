  ...
  def to_check_string
    ...
    if dollars.length == 2
      ...
      if dollars[1].length == 3
        dollar_string += ones[dollars[1][0].to_i] + ' hundred' + (dollars[1][1] == '0' ? '' : ' ')
        if dollars[1][1] == '1'
          dollar_string += teens[(dollars[1][1] + dollars[1][2]).to_i] + ' thousand'
        else
          dollar_string += tens[dollars[1][1].to_i]
          dollar_string += (dollars[1][2] == '0' ? '' : ' ') + ones[dollars[1][2].to_i] + ' thousand'
        end
    ...
    if dollars[0].length == 3
      if dollars[0] == '000'
        ...
        dollar_string += ones[dollars[0][0].to_i] + (dollars[0][0] == '0' ? '' : ' hundred') + (dollars[0][1] == '0' ? '' : ' ')
        if dollars[0][1] == '1'
