...
class HistoryTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = game.value(forKeyPath: "datetime") as? String
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if let indexPath = tableView.indexPathForSelectedRow, segue.identifier == "historyToDetails" {
            let game = games[indexPath.row]
            detailsTableViewController.id = game.value(forKeyPath: "id") as! String
        }
    }
