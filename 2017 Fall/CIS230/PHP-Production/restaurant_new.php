...
$form = <<<END_OF_EDITING
  ...
  <form method="POST" action="/restaurant_new.php" class="text-left col-md-6 col-md-offset-3">
    ...
    <div class="form-group">
      ...
      <input class="form-control" name="priceRangeLow" id="priceRangeLow" value="$priceRangeLow" />
    </div>
    
    <div class="form-group">
      <label for="priceRangeHigh">Price Range High:</label>
      <input class="form-control" name="priceRangeHigh" id="priceRangeHigh" value="$priceRangeHigh" />    
    </div>
